...
public class SnowballManager : MonoBehaviour
{
    ...
    private HandGestureRecognitionManager handGestureRecognitionManager;

     private void Start()
     {
         handGestureRecognitionManager = FindObjectOfType<HandGestureRecognitionManager>();
         handGestureRecognitionManager.OnHandGestureChanged += HandleHandGestureChanged;
     }

     private void HandleHandGestureChanged(HandGesture gesture)
    {
         switch (gesture)
        {
